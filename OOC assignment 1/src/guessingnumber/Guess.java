...
public class Guess extends JFrame 
{
    ...
    public Guess()
    {
      ...
      //  Creating image 
        ...
        Image  img = new ImageIcon(this.getClass().getResource("/ooc.jfif")).getImage();
        lblpic.setIcon(new ImageIcon(img));
        lblpic.setBounds(10,50,300,260);
        ...
        JLabel j6=new JLabel("Number of trails");
    ...
    private class ButtonListener2 implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            t3.setText("");
            t4.setText("");
            j4.setText(rand+" is the correct answer!!");
            t1.setText("");
            t1.setEditable(false);
        }
    }        
